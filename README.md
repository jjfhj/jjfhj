...
<p align="left">
Более 3 лет опыта в тестировании web-приложений и обеспечении качества. Регулярно обучаюсь в сфере тестирования. Изучаю новые технологии и совершенствую полученные навыки.

В данное время активно изучаю <code>Java</code>. Закончила курс по автоматизированному тестированию от
...
<p align="center">
    <a href="https://github.com/jjfhj/mvideo_project"><img width=45% title="UI-автотесты для веб-приложения М.Видео с использованием фреймворков Selenide и Allure, Selenoid для запуска браузеров в контейнерах Docker, Jenkins для запуска тестов, интеграцией с Allure TestOps, Jira, Telegram, Slack и электронной почтой" src="https://github-readme-stats.vercel.app/api/pin/?username=jjfhj&repo=mvideo_project&show_owner=true&theme=buefy"></a>
